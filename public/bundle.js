	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            Link,
	                            { className: 'nav-link', activeClassName: 'active', to: '/examples' },
	                            'Examples'
	                        )
	                    )
	                )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	    ...
	    handleSearchLocation: function handleSearchLocation(locale) {
	        var me = this;
	        this.setState({
	            isLoading: true
	        });
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'h1',
	                    { className: 'mx-sm-5 px-sm-5 mb-5' },
	                    'Get Weather'
	                ),
	                React.createElement(WeatherForm, { onSearch: this.handleSearchLocation }),
	                renderMessage()
	            )
	        );
	    }
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Enter city name', ref: 'cityName' })
	                ),
	                React.createElement(
	                    'button',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    getWeather: function getWeather(location) {
	        var locale = encodeURIComponent(location);
	        var url = 'http://api.openweathermap.org/data/2.5/weather?q=' + locale + '&appid=ba82675f1e760ed1b00fe3d4f1daf4b0&units=metric';
